...
clean:
	rm -f index.md 1_create_server.ipynb 2_launch_containers.ipynb 3_student_exercise_1.ipynb 4_student_exercise_2.ipynb 5_delete.ipynb

index.md: snippets/create_server.md snippets/launch_containers.md snippets/student_exercise_1.md snippets/student_exercise_2.md snippets/delete.md snippets/footer.md
	cat snippets/create_server.md snippets/launch_containers.md snippets/student_exercise_1.md snippets/student_exercise_2.md snippets/delete.md snippets/footer.md > index.tmp.md
